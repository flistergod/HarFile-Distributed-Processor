...
public class HarLog {
    ...
    private harreader.model.HarCreatorBrowser creator;
    private harreader.model.HarCreatorBrowser browser;
    private List<harreader.model.HarPage> pages = new ArrayList<>();
    private List<harreader.model.HarEntry> entries = new ArrayList<>();
     ...
     */
    public harreader.model.HarCreatorBrowser getCreator() {
        if (creator == null) {
            creator = new harreader.model.HarCreatorBrowser();
        }
        return creator;
    }

    public void setCreator(harreader.model.HarCreatorBrowser creator) {
     ...
     */
    public harreader.model.HarCreatorBrowser getBrowser() {
        if (browser == null) {
            browser = new harreader.model.HarCreatorBrowser();
        }
        return browser;
    }

    public void setBrowser(harreader.model.HarCreatorBrowser browser) {
     ...
     */
    public List<harreader.model.HarPage> getPages() {
        if (pages == null) {
            pages = new ArrayList<>();
        }
        return pages;
    ...
    public void setPages(List<harreader.model.HarPage> pages) {
        this.pages = pages;
    }
     ...
     */
    public List<harreader.model.HarEntry> getEntries() {
        if (entries == null) {
    ...
    public void setEntries(List<harreader.model.HarEntry> entries) {
    ...
    public void writeHar(JsonGenerator g) throws JsonGenerationException, IOException {
       ...
       // this.creator.writeHar(g);
        ...
        while(var2.hasNext()) {
            harreader.model.HarEntry entry = (harreader.model.HarEntry)var2.next();
            entry.writeHar(g);
        }
