...
public class HarPostData {
    ...
    private List<harreader.model.HarPostDataParam> params = new ArrayList<>();
    private String text;
     ...
     */
    public List<harreader.model.HarPostDataParam> getParams() {
        if (params == null) {
    ...
    public void setParams(List<harreader.model.HarPostDataParam> params) {
        this.params = params;
    }
