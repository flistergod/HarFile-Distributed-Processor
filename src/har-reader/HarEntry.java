...
public class HarEntry {
    ...
    private harreader.model.HarRequest request;
    private harreader.model.HarResponse response;
    private harreader.model.HarCache cache;
    private harreader.model.HarTiming timings;
     ...
     */
    public harreader.model.HarRequest getRequest() {
        if (request == null) {
            request = new harreader.model.HarRequest();
        }
        return request;
    }

    public void setRequest(harreader.model.HarRequest request) {
     ...
     */
    public harreader.model.HarResponse getResponse() {
        if (response == null) {
            response = new harreader.model.HarResponse();
        }
        return response;
    }

    public void setResponse(harreader.model.HarResponse response) {
     ...
     */
    public harreader.model.HarCache getCache() {
        if (cache == null) {
            cache = new harreader.model.HarCache();
        }
        return cache;
    }

    public void setCache(harreader.model.HarCache cache) {
        this.cache = cache;
    }
     ...
     */
    public harreader.model.HarTiming getTimings() {
        if (timings == null) {
            timings = new harreader.model.HarTiming();
        }
        return timings;
    }

    public void setTimings(harreader.model.HarTiming timings) {
